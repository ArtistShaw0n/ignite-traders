  ...
  return (
    <div ref={rootRef} className={clsx("relative inline-block", className)}>
      <button
        ...
        aria-expanded={open}
        className={clsx(
          "inline-flex items-center justify-between gap-2 min-w-[180px] px-4 py-2.5 rounded-md border border-[var(--border-default)] bg-[var(--bg-surface)] text-body-sm text-[var(--fg-primary)] hover:bg-[var(--bg-surface-muted)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:ring-offset-2",
          buttonClassName,
        )}
      >
        ...
        <ChevronDown
          size={16}
          className={clsx(
            "flex-shrink-0 text-[var(--fg-muted)] transition-transform",
            open && "rotate-180",
          )}
        />
      </button>
