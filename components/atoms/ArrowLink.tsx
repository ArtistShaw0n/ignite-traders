...
export function ArrowLink(props: ArrowLinkProps) {
  ...
  const classes = clsx(
    "group inline-flex items-center gap-1.5 text-body-sm font-semibold text-brand-500 hover:text-brand-600 dark:text-brand-400 dark:hover:text-brand-300 transition-colors",
    className,
  );
